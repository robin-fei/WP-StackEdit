...
class stackedit_prismjs {
	...
	public function prism_styles_scripts() {
		$prism_library = $this->opt( 'prism_library' );
		$prism_style   = $this->opt( 'prism_style' );

		$prism_base_url = isset( $prism_library ) ? $prism_library : '//cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/';//资源载入地址
		$prism_theme    = isset( $prism_style ) ? $prism_style : 'default';//语法高亮风格
